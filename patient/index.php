                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Haven't any idea about Health Advocate? no problem let's jumping to 
                                <a href="doctors.php" class="non-style-link"><b>"All Health Advocates"</b></a> section or 
                            ...
                            <h3>Channel a Health Advocate Here</h3>
                            <form action="schedule.php" method="post" style="display: flex">

                                <input type="search" name="search" class="input-text " placeholder="Search Health Advocate and We will Find The Session Available" list="doctors" style="width:45%;">&nbsp;&nbsp;
